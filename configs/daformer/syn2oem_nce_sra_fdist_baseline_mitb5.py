...
_base_ = [
    ...
    '../_base_/datasets/ssda_syntheworld_to_oem_512x512.py',
...
uda = dict(
    ...
    # imnet_feature_dist_classes=range(8),
    # imnet_feature_dist_scale_min_ratio=0.75,
    nce_loss_weight=0.1,
    nce_loss_temp = 0.07,
    # nce_active_classes = [0, 1, 2, 3, 4, 5, 8, 9, 10, 11, 13, 14, 15], # majority + medium classes
    nce_active_classes = range(8), # only majority classes
)
data = dict(
    samples_per_gpu=4,
    workers_per_gpu=4,)
...
name = 'nce0.1_majorclass_sra_baseline_mitb5_40k'
exp = 'syn2oem'
name_dataset = 'syn2oem'
